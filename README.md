...
[JIRA PROJECT](https://susanaqa.atlassian.net/jira/software/projects/PQA/boards/3/backlog)
...
## 11. Deliverables
- **[Functional Test Results](test_results_report.pdf)**: A document summarizing the execution and results of all functional test cases.
- **[BUG Report](Error_report.pdf)**: Detailed documentation of any defects found during testing, including severity, steps to reproduce, and resolution.
- **[Regression Test Execution Report](regression_test_report.pdf)**: A report outlining the results of regression tests executed at the end of each sprint.

## AUTHOR
Susana Gonzalez, QA Analyst
